# What is Proxy-Chain-Headers-Extension
Proxy-Chain-Headers-Extension it's an extension of Proxy-Chain package (package for which you have the description below). This package only adds the headers option to the package.
